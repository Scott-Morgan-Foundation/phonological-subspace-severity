"""Figure 5 (v8): inter-backbone Spearman rho on the >=3-feature composite.

Source: results/v8/v8_test6.json (corrected inputs, keep-last for duplicated keys), full-precision rho,
rounded once to 3 decimals for the cell labels (v7 check N-28/N-29: the v5 figure rounded 4-dp JSON values).
...
SRC = BASE / "results" / "v8" / "v8_test6.json"
OUT_PDF = BASE / "figures" / "fig5_intermodel_v8.pdf"
OUT_PNG = BASE / "figures" / "fig5_intermodel_v8.png"
