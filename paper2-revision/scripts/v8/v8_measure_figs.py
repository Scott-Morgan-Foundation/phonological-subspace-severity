"""v8 copy of scripts/v6/v6_measure_figs.py (v8 PDF, outputs under results/v8): measure placed text sizes of Figures 1-5 in the compiled PDF and render the figure pages
...
common.OUT = common.REV / "results" / "v8"
from common import REV, write  # noqa: E402

PDF = REV / "paper2-csl_v8.pdf"
REN = REV / "results" / "v8" / "renders"
...
write("v8_fig_text_sizes.json", out, [PDF])
