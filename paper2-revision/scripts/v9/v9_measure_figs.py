"""v9 copy of scripts/v8/v8_measure_figs.py (v9 PDF, outputs under results/v9): measure placed text sizes of Figures 1-5 in the compiled PDF and render the figure pages
...
common.OUT = common.REV / "results" / "v9"
from common import REV, write  # noqa: E402

PDF = REV / "paper2-csl_v9.pdf"
REN = REV / "results" / "v9" / "renders"
...
write("v9_fig_text_sizes.json", out, [PDF])
